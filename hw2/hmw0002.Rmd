...
# кссумирует неполные данные (с отсутствующим значением - na)
...
#на сколько я понял функция в строке 3 считает каждый элемент массива со значением na по столбцам, а na.omit - если вся строка пустая. ьак что нет.
```
```
#Новые дома
...
#добавляем в вектор acc номера строк принадлежащих штату 6(Калифрноия) и городу с номером 1
#сохраним в вектор accmv медианы стоимости домов.
#находим медиану получившегося вектора
